  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-11 w-11 items-center justify-center text-[#111111]"
        aria-expanded={open}
      ...
      {rendered && (
        <div
          className={`fixed inset-0 z-50 bg-black/12 backdrop-blur-sm ${
        ...
        >
          <div
            ...
            className={`flex min-h-svh w-full flex-col bg-[#fbfbf8] px-6 pb-10 pt-6 text-[#111111] ${
              open
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="font-display text-[1.75rem] font-semibold tracking-[0.02em] text-[#111111] animate-[hero-rise_360ms_cubic-bezier(0.22,1,0.36,1)] sm:text-[1.95rem]">
                  {copy.brand}
                </p>
              </div>
              <button
                type="button"
                onClick={closeMenu}
                className="inline-flex h-11 w-11 items-center justify-center text-[#111111] animate-[hero-rise_360ms_cubic-bezier(0.22,1,0.36,1)]"
                ...
                return (
                  <a
                    ...
                    className={`border-b border-black/10 py-4 text-[0.78rem] uppercase tracking-[0.22em] animate-[hero-rise_420ms_cubic-bezier(0.22,1,0.36,1)] ${
                      active ? "text-[#111111]" : "text-[rgba(17,17,17,0.56)]"
                    }`}
            ...
            <div className="space-y-3 border-t border-black/10 pt-6">
              <a
                href={alternatePath}
                onClick={closeMenu}
                className="inline-flex text-[0.78rem] uppercase tracking-[0.22em] text-[rgba(17,17,17,0.56)] underline-offset-4 hover:text-[#111111] hover:underline animate-[hero-rise_420ms_cubic-bezier(0.22,1,0.36,1)]"
